...
export const SOURCE_ORDER: Source[] = ['reddit', 'valuepickr', 'news', 'tradingqna'];
...
> = {
  ...
  tradingqna: { label: 'TradingQnA', color: 'text-tradingqna', dot: 'bg-tradingqna', soft: 'bg-tradingqna/15', hex: '#4ea3e0' },
};
